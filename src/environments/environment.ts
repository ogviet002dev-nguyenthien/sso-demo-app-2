...
export const environment = {
  ...
  loginURL:
    'https://testing-login.auth.ap-northeast-1.amazoncognito.com/oauth2/authorize?client_id=4lutbcibf2go2s27tr82ssvdgd&response_type=code&scope=openid+profile&redirect_uri=http%3A%2F%2Flocalhost%3A4300%2Fdashboard',
